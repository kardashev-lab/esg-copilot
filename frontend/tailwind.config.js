...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'esg': '0 10px 25px -5px rgba(16, 185, 129, 0.1), 0 10px 10px -5px rgba(16, 185, 129, 0.04)',
      },
      backgroundImage: {
        'esg-gradient': 'linear-gradient(135deg, #10b981 0%, #3b82f6 100%)',
        'esg-gradient-secondary': 'linear-gradient(135deg, #8b5cf6 0%, #f59e0b 100%)',
      },
    },
  },
  plugins: [
